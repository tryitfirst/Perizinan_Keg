...
<form>
  <h1>Form Pengajuan Proposal Kegiatan</h1>
  <div class="inset">

	<?php 
    echo form_open_multipart('upload/do_upload');?>
    <center><h2><label for="title">Nama Kegiatan :</label></h2>
    <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="" />
    <h2><label for="title">Tanggal Kegiatan</label></h2></center>
    
   <center>
<div id="pos" class="demo">
        <div class="sample">
        <input type="text" data-beatpicker="true" data-beatpicker-position="['right','bottom']" name="tanggal_kegiatan" id="tanggal_kegiatan" value=""/>
<pre class="code-prev">
...
<center>
    <h2><label for="title">Dana yang digunakan :</label></h2>
    
     <center>
    <select name="dana">      
<option value="1">Jurusan</option>
<option value="0">Himpunan</option>

</select>
</center>
<br>
</br>
    <h2><input type="file" name="userfile" size="20" /></h2>
    <h2><input type="submit" value="upload" /></h2>
<br /><br />
